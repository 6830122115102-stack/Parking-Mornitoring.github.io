-- Parking System Database Schema for Supabase (Clean Version)
-- Run this in Supabase SQL Editor

-- Drop existing policies first
DROP POLICY IF EXISTS "Allow public read access to parking spots" ON parking_spots;
DROP POLICY IF EXISTS "Allow authenticated users to update parking spots" ON parking_spots;
DROP POLICY IF EXISTS "Allow public read access to parking history" ON parking_history;
DROP POLICY IF EXISTS "Allow authenticated users to insert parking history" ON parking_history;
